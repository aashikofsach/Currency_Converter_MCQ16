    ...
    return (
        <div>
            ...
            <div className='mt-1 mb-1 relative  '>
                  <select onChange={(e) => setCurrency(e.target.value)} value={currency} name="" id="" className='w-full p-2 pr-8 bg-gray-300 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500'>
                    <hr />
                {
